...
function Dropdown({ setSidebarCollapsed, routes }) {
  ...
  return (
    <div className='mt-4'>
      <button
        className="relative text-blue-800 text-base font-medium w-full text-left focus:outline-none flex items-center justify-between"
...
function SidebarLink({ route, onClick }) {
  ...
  return (
    <Link href={route.path}>
      <a onClick={onClick} className={linkClasses}>
        {route.title}
      </a>
    </Link>
  )
