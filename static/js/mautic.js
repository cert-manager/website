...
function initHandleMauticFormReset() {
  ...
  form.addEventListener("reset", function() {
    ...
    // Remove subscription-form__input--has-value class to reset styles on subscription page
    $(form)
      .find(".subscription-form__input--has-value")
      .removeClass("subscription-form__input--has-value");
  });
}
