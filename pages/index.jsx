...
import CertManagerDiagram from '../components/snippets/CertManagerDiagram'
  ...
  return (
    <>
      ...
      <div className="bg-gray-1 relative overflow-x-hidden pb-117px">
        ...
        <div className="hidden lg:block absolute top-400px right-0 z-0">
          <CirclesBackground />
        </div>
        <div className="relative z-100">
          ...
          <div className="container">
            ...
            <CertManagerDiagram className="mb-16 lg:mt-20"/>
