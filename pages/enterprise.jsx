...
import { meta as page } from '../content/pages/enterprise.mdx'

function Enterprise({ router }) {
            ...
            <div className='bg-black px-9 py-8 rounded-5px relative overflow-hidden'>
              ...
              <div className='relative z-100'>
                ...
                <Link href={page.intro.cta.href}>
                  <a className='inline-block bg-indigo px-6 py-3 rounded-5px text-white text-sm no-underline'>{page.intro.cta.caption}</a>
                </Link>
              </div>
            </div>
          </div>
