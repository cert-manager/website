...
```console
$ curl -L -o kubectl-cert-manager.tar.gz https://github.com/jetstack/cert-manager/releases/download/v1.6.3/kubectl-cert_manager-linux-amd64.tar.gz
...
1. Download the [latest version](https://github.com/jetstack/cert-manager/releases/download/v1.6.3/kubectl-cert_manager-windows-amd64.tar.gz).
