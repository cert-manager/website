...
```bash
# OpenShift 4+
oc apply --validate=false -f https://github.com/cert-manager/cert-manager/releases/download/v1.0.4/cert-manager.yaml

# OpenShift 3.11
$ oc apply --validate=false -f https://github.com/cert-manager/cert-manager/releases/download/v1.0.4/cert-manager-legacy.yaml
```
