...
[`cert-manager.yaml`](https://github.com/cert-manager/cert-manager/releases/download/v0.13.1/cert-manager.yaml)
file, you should instead use the
[`cert-manager-no-webhook.yaml`](https://github.com/cert-manager/cert-manager/releases/download/v0.13.1/cert-manager-no-webhook.yaml)
...
```bash
$ kubectl delete -f https://github.com/cert-manager/cert-manager/releases/download/v0.13.1/cert-manager.yaml
$ kubectl apply -f https://github.com/cert-manager/cert-manager/releases/download/v0.13.1/cert-manager-no-webhook.yaml
```
