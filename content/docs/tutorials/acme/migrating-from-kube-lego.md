...
5. Configured cert-manager's [ingress-shim](../../../usage/ingress/index.html) to
...
[installation guide](../../../installation/index.html). No special steps are
...
docs](../../../usage/ingress/index.html), but for now we can just run a `helm
