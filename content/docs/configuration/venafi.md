...
title: Venafi
description: >-
  The Venafi Issuer types allows you to obtain certificates from Venafi as a
  Service (VaaS) and Venafi Trust Protection Platform (TPP) instances.
---
...
Read the [Issuing Certificates](../usage/certificate.md) document for more
