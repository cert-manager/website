      ...
      <td>
        ...
        <table>
          ...
          <tr>
            ...
            <td>
              <em>(Optional)</em>
              <p> The requested &lsquo;duration&rsquo; (i.e. lifetime) of the Certificate. This option may be ignored/overridden by some issuer types. If unset this defaults to 90 days. If overridden and <code>renewBefore</code> is greater than the actual certificate duration, the certificate will be automatically renewed 2/3rds of the way through the certificate&rsquo;s duration. </p>
            </td>
          </tr>
          <tr>
            <td>
            ...
            <td>
              ...
              <p>
                ...
                time that cert-manager will begin to attempt to renew the certificate. If unset this defaults to 30 days. If this value is greater than the total duration of the certificate (i.e. notAfter - notBefore), it will be automatically renewed 2/3rds of the way through the certificate&rsquo;s duration.
              </p>
            </td>
          </tr>
          <tr>
...
<hr />
<p>
  <em> Generated with <code>gen-crd-api-reference-docs</code> on git commit <code>c7526a197</code>. </em>
</p>