export const meta = {
  title: 'cert-manager',
  description: 'Cloud native X.509 certificate management for Kubernetes and OpenShift',
  hero: {
    heading: 'Cloud native certificate management',
    description: 'X.509 certificate management for Kubernetes and OpenShift',
    image: '/images/cert-manager-graphic.png'
  },
  stats: [
    {
      icon: 'github',
      description: '8800+ Github Stars'
    },
    {
      icon: 'slack',
      description: '6000+ Slack members'
    },
    {
      icon: 'downloads',
  ...
  bottomCta: {
    title: 'NEED TO KNOW MORE ABOUT cert-manager?',
    ctas: [
      {
        icon: 'github',
        href: 'https://github.com/cert-manager/cert-manager',
      ...
      {
        icon: '',
        href: 'https://www.jetstack.io/open-source/cert-manager/',
