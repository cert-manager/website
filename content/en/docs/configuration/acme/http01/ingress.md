...
The HTTP01 Ingress issuer supports a number of additional options.  For full details on
the range of options available, read the [reference
documentation](../../../../reference/api-docs/#acme.cert-manager.io/v1.ACMEChallengeSolverHTTP01Ingress).
