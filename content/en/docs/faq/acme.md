...
For example when using GKE with the Google Cloud Loadbalancer it is reccomended to set:
```
cert-manager.io/issue-temporary-certificate: "true"
acme.cert-manager.io/http01-edit-in-place: "true"
```
This will allod the Google Cloud Loadbalancer to propagate a HTTPS endpoint correctly with a temoprary certificate, the `http01-edit-in-place` part will prevent GKE from assigning a 2nd IP address for the challenge endpoint.
