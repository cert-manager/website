...
<td>
<p>Type is the type of ACME challenge this resource represents, e.g. &ldquo;dns01&rdquo;
or &ldquo;http01&rdquo;.</p>
</td>
</tr>
<tr>
<td>
...
should be solved using this challenge solver.</p>
</td>
</tr>
<tr>
<td>
...
<td>
<p>keyAlgorithm is the MAC key algorithm that the key is used for. Valid
values are &ldquo;HS256&rdquo;, &ldquo;HS384&rdquo; and &ldquo;HS512&rdquo;.</p>
</td>
</tr>
</tbody>
</table>
...
<td>
<p>PrivateKey is the name of a secret containing the private key for this
user account.</p>
</td>
</tr>
<tr>
...
ACME challenges for the matching domains.</p>
</td>
</tr>
</tbody>
</table>
...
configuration for Cloudflare</p>
</p>
<table>
<thead>
<tr>
...
<td>
<em>(Optional)</em>
<p>URISANs is a list of URI Subject Alternative Names to be set on this
Certificate.</p>
</td>
</tr>
<tr>
...
<td>
<em>(Optional)</em>
<p>EmailSANs is a list of Email Subject Alternative Names to be set on this
Certificate.</p>
</td>
</tr>
<tr>
...
<td>
<em>(Optional)</em>
<p>IsCA will mark this Certificate as valid for signing.
This implies that the &lsquo;cert sign&rsquo; usage is set</p>
</td>
</tr>
<tr>
<td>
...
empty or is set to &ldquo;rsa&rdquo;, and value must be one of (256, 384, 521) when
KeyAlgorithm is set to &ldquo;ecdsa&rdquo;.</p>
</td>
</tr>
<tr>
<td>
...
<td>
<em>(Optional)</em>
<p>IsCA will mark the resulting certificate as valid for signing. This
implies that the &lsquo;cert sign&rsquo; usage is set</p>
</td>
</tr>
<tr>
<td>
...
<td>
<em>(Optional)</em>
<p>Usages is the set of x509 actions that are enabled for a given key.
Defaults are (&lsquo;digital signature&rsquo;, &lsquo;key encipherment&rsquo;) if empty</p>
</td>
</tr>
</table>
</td>
...
<p>
<p>CertificateStatus defines the observed state of CertificateRequest and
...
<td>
<em>(Optional)</em>
<p>Byte slice containing a PEM encoded signed certificate resulting from the
given certificate signing request.</p>
</td>
</tr>
<tr>
<td>
...
<td>
<em>(Optional)</em>
<p>Byte slice containing the PEM encoded certificate authority of the signed
certificate.</p>
</td>
</tr>
<tr>
...
<p>
<p>Vault authentication  can be configured:
...
<td>
<em>(Optional)</em>
<p>This contains a Role and Secret with a ServiceAccount token to
...
<td>
<em>(Optional)</em>
<p>Base64 encoded CA bundle to validate Vault server certificate. Only used
...
TODO: Add other useful fields. apiVersion, kind, uid?</p>
</td>
</tr>
</tbody>
</table>
...
on git commit <code>ce9d9c1c1</code>.
</em></p>
