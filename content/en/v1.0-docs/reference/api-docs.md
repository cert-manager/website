...
If specified, this value must also be present in <code>dnsNames</code>.
...
If overridden and <code>renewBefore</code> is greater than the actual certificate
duration, the certificate will be automatically renewed 2/3rds of the
way through the certificate&rsquo;s duration.</p>
</td>
</tr>
<tr>
<td>
...
<td>
<em>(Optional)</em>
<p>The amount of time before the currently issued certificate&rsquo;s <code>notAfter</code>
...
the way through the certificate&rsquo;s duration.</p>
</td>
</tr>
<tr>
<td>
...
If the &lsquo;kind&rsquo; field is not set, or set to &lsquo;Issuer&rsquo;, an Issuer resource
with the given name in the same namespace as the Certificate will be used.
If the &lsquo;kind&rsquo; field is set to &lsquo;ClusterIssuer&rsquo;, a ClusterIssuer with the
provided name will be used.
The &lsquo;name&rsquo; field in this stanza is required at all times.</p>
</td>
</tr>
<tr>
<td>
...
field.</p>
<p>A CertificateRequest is a &lsquo;one-shot&rsquo; resource, meaning it represents a single
...
the &lsquo;kind&rsquo; field is not set, or set to &lsquo;Issuer&rsquo;, an Issuer resource with
the given name in the same namespace as the CertificateRequest will be
used.  If the &lsquo;kind&rsquo; field is set to &lsquo;ClusterIssuer&rsquo;, a ClusterIssuer with
the provided name will be used. The &lsquo;name&rsquo; field in this stanza is
required at all times. The group field refers to the API group of the
issuer which defaults to &lsquo;cert-manager.io&rsquo; if empty.</p>
</td>
</tr>
<tr>
<td>
...
<td>
<p>Type of the condition, known values are (&lsquo;Ready&rsquo;, <code>Issuing</code>).</p>
</td>
</tr>
<tr>
<td>
...
If provided, allowed values are &ldquo;pkcs1&rdquo; and &ldquo;pkcs8&rdquo; standing for PKCS#1
and PKCS#8, respectively.
Defaults to PKCS#1 if not specified.</p>
</td>
</tr>
<tr>
<td>
...
for this certificate. If provided, allowed values are either &ldquo;rsa&rdquo; or &ldquo;ecdsa&rdquo;
If <code>algorithm</code> is specified and <code>size</code> is not provided,
key size of 256 will be used for &ldquo;ecdsa&rdquo; key algorithm and
key size of 2048 will be used for &ldquo;rsa&rdquo; key algorithm.</p>
</td>
</tr>
<tr>
<td>
...
<td>
<p>Type of the condition, known values are (&lsquo;Ready&rsquo;, &lsquo;InvalidRequest&rsquo;).</p>
</td>
</tr>
<tr>
<td>
...
<td>
<p>Type of the condition, known values are (&lsquo;Ready&rsquo;).</p>
</td>
</tr>
<tr>
<td>
...
values are &ldquo;pkcs1&rdquo; and &ldquo;pkcs8&rdquo; standing for PKCS#1 and PKCS#8, respectively.
If KeyEncoding is not specified, then PKCS#1 will be used by default.</p>
</td>
</tr>
<tr>
<td>
...
on git commit <code>4d870e49b</code>.
</em></p>
