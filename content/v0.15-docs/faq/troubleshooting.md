...
The cert-manager flow all starts at a `Certificate` resource, you can create this yourself or your Ingress resource will to this for you if you have the [correct annotations](../usage/ingress.md) set. 
